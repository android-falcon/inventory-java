...
@Database(entities = {ItemCard.class, ItemSwitch.class, ItemUnit.class, OfferTable.class}, version =  110 , exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    static final Migration FROM_1_TO_2 = new Migration(99, 107) {
        @Override
